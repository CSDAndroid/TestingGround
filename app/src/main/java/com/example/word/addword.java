...
//            cursor.moveToLast();
            ...
            Cursor cursor = getContentResolver().query(Uri.parse("words"),new String[]{"word","translation"},null,null,null,null);
            int nameIndex = cursor.getColumnIndexOrThrow(ContactsContract.Contacts.DISPLAY_NAME);
//            public String word=cursor.getString(cursor.getColumnIndexOrThrow(ContactsContract.Contacts."word"));
